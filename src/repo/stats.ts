...
function convertDbRowToSeasonStatsRow(dbRow: SeasonStatsDbRow): SeasonStatsRow {
  return {
    ...
    yardsPerGameLast3: dbRow["Yards_per_Game_(Last_3)"],
    yardsPerGameLast1: dbRow["Yards_per_Game_(Last_1)"],
    yardsPerGameHome: dbRow["Yards_per_Game_(Home)"],
    yardsPerGameAway: dbRow["Yards_per_Game_(Away)"],
    pointsPerGame: dbRow.Points_Per_Game,
    pointsPerGameLast3: dbRow["Points_Per_Game_(Last_3)"],
    pointsPerGameLast1: dbRow["Points_Per_Game_(Last_1)"],
    pointsPerGameHome: dbRow["Points_Per_Game_(Home)"],
    pointsPerGameAway: dbRow["Points_Per_Game_(Away)"],
    ...
    fpi: dbRow.fpi,
    fpiOffense: dbRow.fpi_off,
    fpiDefense: dbRow.fpi_def,
  };
}
